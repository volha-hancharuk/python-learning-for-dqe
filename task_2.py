...
for d in dict_list:                                               # iterate through each dict in dict list
...
for kc, vc in counts.items():                                     # iterate through each key, value in counted keys
    if counts[kc] == 1:                                           # if letter appears 1 time
        for d in dict_list:                                       # iterate through every dict in dict list
        ...
        for i, d in enumerate(dict_list, 1):                      # iterate through each dict in dict list
            if kc in d:                                           # check if letter is in dict
                value = d[kc]                                     # save value of letter
